...
export type ExchangeExtensionTokenRequest = z.infer<typeof ExchangeExtensionTokenRequestSchema>

export const ExchangeExtensionTokenResponseSchema = z.object({
	accessToken: z.string(),
	refreshToken: z.string(),
})
export type ExchangeExtensionTokenResponse = z.infer<typeof ExchangeExtensionTokenResponseSchema>
